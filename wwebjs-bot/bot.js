...
client.once("ready", () => {
  ...
  setTimeout(function () {
    setInterval(BulksendMessage, 100000);
  }, 100000);
});
...
// const chatid_myslef = "919747200785@c.us";
// const chatid_test = "62877825746056@c.us";
const chatid_myslef = "918891671503@c.us";
// const junaid_number = "9747200785";
const junaid_number = "8891671503";
...
const final_messge =
  "എന്റെ UAE  നമ്പർ എന്റെ കയ്യിൽ ഇല്ല .പ്ളീസ് ദയവായി അത് ഒന്ന് ഷെയർ ചെയ്യൂ .കടം തന്നത് ചോദിക്കാനാണ് ചിലപ്പോൾ അബുദാബി വരുമ്പോൾ കാണാല്ലോ ";
